...
class VQTokenDecoder(nn.Module):
    ...
    Architecture:
        ...
        → ResBlocks for spatial reasoning → 1×1 conv → (codebook_size, 7, 7)
    ...
    def __init__(
        ...
        # Neighboring tokens share information through 3×3 convolutions
        ...
        # Step 3: Per-position token prediction via 1×1 conv
